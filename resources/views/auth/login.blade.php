        ...
        <div
            ...
            <div class="hidden lg:flex w-1/2 bg-indigo-600 relative overflow-hidden p-12 flex-col justify-between">
                ...
                <div class="relative z-10">
                    <h2 class="text-4xl font-bold text-white leading-tight mb-4">
                        The fastest way to <br> <span class="text-indigo-200">the interview.</span>
                    </h2>
                    <p class="text-indigo-100 text-lg">Our AI handles the formatting and wording. You handle the
                        handshake.</p>
                </div>
            ...
            <div class="w-full lg:w-1/2 p-8 md:p-16 flex flex-col justify-center relative overflow-hidden">
                ...
                <div class="w-full">
                    ...
                    <p class="text-slate-500 mb-8">Enter your credentials to access your resumes.</p>
                    ...
                    <div class="relative flex py-2 items-center mb-6">
                        ...
                        <span class="flex-shrink-0 mx-4 text-slate-300 text-xs font-bold uppercase">Or continue with
                            email</span>
                        <div class="flex-grow border-t border-slate-100"></div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required
                                class="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all duration-300"
                                placeholder="name@company.com">
                        </div>
                        <div>
                            <div class="flex justify-between mb-2">
                                <label
                                    class="block text-xs font-bold text-slate-400 uppercase tracking-widest">Password</label>
                    ...
                    <p class="text-center mt-8 text-slate-500">
                        ...
                        <a href="{{ route('register') }}" class="text-indigo-600 font-bold hover:underline">Create
                            one</a>
                    </p>
                </div>
            </div>
